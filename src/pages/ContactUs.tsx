        ...
        <div className="bg-blue-950 md:col-span-4 p-10 text-white">
          ...
          <div className="flex items-center mt-5">
            ...
            <span className="text-sm">
              House #14, Road #12, Dhanmondi, Dhaka, Bangladesh.
            </span>
          </div>
          <div className="flex items-center mt-5">
            <svg
        ...
        <form className="md:col-span-8 p-10">
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className="flex justify-between w-full px-3">
              ...
              <button
                className="shadow bg-blue-500 hover:bg-blue-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded"
                type="submit"
              >
                Send Message
              </button>
